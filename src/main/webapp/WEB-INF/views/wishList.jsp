    ...
    <script>
      ...
      function init() {
        ...
        for(idx=0; idx < json_WishList.length; idx++){
            wishList +="<div class=\"product__item item wish\" onClick=\"moveProductInfo(\'"+ json_WishList[idx].prdCteCode +"\',\'"+ json_WishList[idx].prdSelCode  + "\',\'" + json_WishList[idx].prdCode + "\')\">\r\n"
        ...
        <nav class="common__menu__Zone">
          <div class="common__menu">
            ...
            <div class="common__menu__list">
              ...
              <div
                class="common__menu__item parentItem"
                onclick="moveWishList()" style="color:red ;"
              >
                찜한 상품
              </div>
              <div
