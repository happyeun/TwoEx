  ...
  <head>
    ...
    <script>
      ...
      function init() {
        ...
        for(idx=0; idx < json_ordersList.length; idx++){
          ordersList +=  "<div class=\"product__item item" +idx + "\" onClick=\"moveProductInfo(\'"+ json_ordersList[idx].prdCteCode +"\',\'"+ json_ordersList[idx].prdSelCode  + "\',\'" + json_ordersList[idx].prdCode + "\')\">\r\n"
    ...
    function createFormInput(name, value){
      ...
      function orderListMonthCB(ajaxData){
        ...
        for(idx=0; idx < json_ordersList.length; idx++){
          ordersList +=  "<div class=\"product__item item" +idx + "\">\r\n"
				+ "  <div class=\"product__image__div\">\r\n"
				+ "      <img class=\"product__image\" src=\"" +json_ordersList[idx].prfLocation +"\">\r\n"
				+ "  </div>\r\n"
				+ "  <div class=\"product__seller__div\">\r\n"
        + "      <div style=\"text-align: center;\"><strong> 구매 날짜 : </strong>"  + json_ordersList[idx].ordDate +"</div>\r\n"
				...
				+ "  </div>\r\n"
				+ "  <div class=\"product__etc__div\">\r\n"
        + " <input type=\"button\" class=\"content__btn btn__blueGreen myPage\" onClick=\"moveProductInfo(\'"+ json_ordersList[idx].prdCteCode +"\',\'"+ json_ordersList[idx].prdSelCode  + "\',\'" + json_ordersList[idx].prdCode + "\')\"/>"
				+ "  </div>\r\n"
				+ "</div>"
      ...
      <div class="navbar__upper">
        ...
        <div class="header__right">
          ...
          <ul class="navbar__menu">
            <li class="navbar__menu__item myPage">
              마이페이지
            </li>
            <li class="navbar__menu__item myShop">
              마이샵
            </li>
            <div class="navbar__menu__item profile"></div>
            <li class="navbar__menu__item login">로그아웃</li>
          </ul>
        ...
        <nav class="common__menu__zone">
          <div class="common__menu">
            ...
            <div class="common__menu__list">
              ...
              <div
                class="common__menu__item parentItem"
                onclick="moveOrderHistory()" style="color:red ;"
              >
                주문 목록
              </div>
              <div
        ...
        <!--[공통 컨텐츠 시작] ------------------------------>
          <div class="common__content__zone lse myPage">
              ...
              <div class="btn__container">
                  ...
                  <input class="content__btn btn__medium ord" type="Date"  name="orderDate"> ~ <input class="content__btn btn__medium" type="Date" name="orderDate"> <input class="content__btn btn__small" type="button" value="조회" onclick="orderDate()">
              </div>
