        ...
        <nav class="common__menu__Zone">
          <div class="common__menu">
            <div class="common__menu__title">
             ...
             <!--[공통 컨텐츠 시작] ------------------------------>
        <div class="common__contents__zone">
          <div>통계조회 페이지</div>
                ...
                data: { // 차트에 들어갈 데이터
                    ...
                    datasets: [
                        { //데이터
                            ...
                            data: [
                            	 '${lifeSellSellStatistics}','${businessSellStatistics}','${mediaSellStatistics}','${techSellStatistics}','${designSellStatistics}','${financeSellStatistics}','${lawSellStatistics}','${hobbySellStatistics}' //x축 label에 대응되는 데이터 값
                                ],
            ...
            data: { // 차트에 들어갈 데이터
                ...
                datasets: [
                    { //데이터
                        ...
                        fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                        data: [
                        	'${age10MarketSell}','${age20MarketSell}','${age30MarketSell}','${age40MarketSell}','${age50MarketSell}','${age60MarketSell}' //x축 label에 대응되는 데이터 값
                        ],
                        backgroundColor: [
                            //색상
                            'rgba(255, 99, 132, 0.2)',
        ...
        data: { // 차트에 들어갈 데이터
            ...
            datasets: [
                { //데이터
                    ...
                    fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                    data: [
                        '${sellMaleStatistics}','${sellFemaleStatistics}' //x축 label에 대응되는 데이터 값
                    ],
                    backgroundColor: [
                        //색상
                        'rgba(255, 99, 132, 0.2)',
    ...
    data: { // 차트에 들어갈 데이터
        ...
        datasets: [
            { //데이터
                ...
                fill: false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
                data: [
                    '${sellMonth2Statistics}','${sellMonthStatistics}' //x축 label에 대응되는 데이터 값
                ],
                backgroundColor: [
                    //색상
                    'rgba(255, 99, 132, 0.2)',
